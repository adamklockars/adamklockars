# Django settings for adamklockars project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': './adamklockars.db',                      # Or path to database file if using sqlite3.
...
# STATIC_URL = 'http://adamklockars.s3-website-us-east-1.amazonaws.com/'
STATIC_URL = '/static/'
...
ROOT_URLCONF = 'adamklockars.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'adamklockars.wsgi.application'
